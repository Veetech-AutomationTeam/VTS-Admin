...
public class Transport_Module extends Extent_Report{
	WebDriver driver;
	...
	@BeforeClass
	  public void Init() throws Exception {
		...
		@Test(priority=0)
		    ...
		    logger.log(LogStatus.PASS, "Test Case Transport request is Passed");
			}
			//approver
				@Test(priority=1)
				public void transport_Approver_Ticket() throws Exception
				{
				    ...
				    logger.log(LogStatus.PASS, "Test Case Transport Approval is Passed");
				}
				...
				//resolver role
						public void tranport_Resolve_Ticket() throws Exception
						{
						    ...
						    driver.switchTo().alert().accept();
						    driver.close();
						    logger.log(LogStatus.PASS, "Test Case Transport Resover is Passed");
